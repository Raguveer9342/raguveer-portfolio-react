export const projectsData = [
  ...
  {
    id: "project-02",
    indexText: "PROJECT 02",
    title: "PROJECT COMING SOON",
    description: "This placeholder is ready for your second project. Simply update the details in the data directory and it will render automatically.",
  ...
  {
    id: "project-03",
    indexText: "PROJECT 03",
    title: "PROJECT COMING SOON",
    description: "This placeholder is ready for your third project. Centralized project data simplifies portfolio management as your development skills grow.",
    image: "src/assets/project-placeholder.jpg",
